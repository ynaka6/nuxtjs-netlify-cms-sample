  ...
  <div class="max-w-4xl mx-auto px-2">
    <div class="flex flex-col md:flex-row">
      <div class="w-full py-4 md:px-4">
        <div class="bg-white border shadow-md rounded lg:px-8 pt-6 pb-8 mt-5 mb-10">
          <p class="text-center">
            お問い合わせありがとうございます。<br>
            問い合わせで入力頂いたメールアドレスにて返答させて頂きます。
          </p>
          <img src="~/assets/img/undraw_mailbox_re_dvds.png" alt="" class="w-64 mx-auto my-6"/>
          <div>
            <nuxt-link
              to="/"
...
export default Vue.extend({
  fetch(context: Context) {
    const breadcrumbs = [
      ...
      { to: '/contact', name: '問い合わせ', color: 'text-gray-100' } as Breadcrumb,
